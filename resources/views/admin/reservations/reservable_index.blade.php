                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="{{ route('admin.reservations.create') }}" class="btn btn-outline-info">{{ __('予約枠追加') }}</a>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">
                                        <div class="flex items-center justify-content-center mt-4 mb-4">
                                            <form action="{{ route('admin.reservations.delete', $reservation->id) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
